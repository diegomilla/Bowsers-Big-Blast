...
public class BBB2H2CPU
{
    ...
    public static void playGame2H2CPU()
    {
        ...
        System.out.println(playerOneName + " and " + playerTwoName + ", your opponents will be:");
        int count = 2;
        //This is will pick out the names of the remaining players, at random
        for (int x = 3; x < 5; x++)
        {
            opponentName = pickOpponents(CPUNames, playerOneName, playerTwoName);
    ...
    public static String pickOpponents(String[] CPUNames, String playerOnesName, String playerTwosName)
    {
        String opponentName = "default";
        ...
        if (opponentName.equals(playerOnesName) || opponentName.equals(playerTwosName))
        {
    ...
    public static String[] roundOne(String[] fourPlayerGroupUnsorted, String[] pumpsR1)
    {
        ...
        while (flag == true)
        {
            ...
            if (fourPlayerGroupUnsorted[temp].equals(playerOneName) || fourPlayerGroupUnsorted[temp].equals(playerTwoName))
            {
                myPick = in.nextInt();
            }
            else
    ...
    public static String[] roundTwo(String[] threePlayerGroupUnsorted, String[] pumpsR2)
    {
        ...
        while (flag == true)
        {
            ...
            System.out.print("Enter the number of the pump of your choice: ");
            if (threePlayerGroupUnsorted[temp].equals(playerOneName) || threePlayerGroupUnsorted[temp].equals(playerTwoName))
            {
                myPick = in.nextInt();
            }
            else
    ...
    //This is where the final round of the game will take place
    public static void roundThree(String[] twoPlayersRemain, String[] pumpsR3)
    {
        ...
        while (flag == true)
        {
            ...
            System.out.print("Enter the number of the pump of your choice: ");
            if (twoPlayersRemain[temp].equals(playerOneName) || twoPlayersRemain[temp].equals(playerTwoName))
            {
                myPick = in.nextInt();
            }
            else
